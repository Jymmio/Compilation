...
public final class ADecSimpleDeclarVar extends PDeclarVar
{
    private PType _type_;
    private TIdentifiant _identifiant_;

    public ADecSimpleDeclarVar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecSimpleDeclarVar(
    ...
    {
        ((Analysis) sw).caseADecSimpleDeclarVar(this);
    }
