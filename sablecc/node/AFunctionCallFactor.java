...
public final class AFunctionCallFactor extends PFactor
{
    private PFunctionCall _functionCall_;

    public AFunctionCallFactor()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AFunctionCallFactor(
    ...
    {
        ((Analysis) sw).caseAFunctionCallFactor(this);
    }
