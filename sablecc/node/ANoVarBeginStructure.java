...
public final class ANoVarBeginStructure extends PBeginStructure
{
    private TLBrace _lBrace_;
    private PStatements _statements_;

    public ANoVarBeginStructure()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ANoVarBeginStructure(
    ...
    {
        ((Analysis) sw).caseANoVarBeginStructure(this);
    }
